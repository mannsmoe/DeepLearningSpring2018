...
# Identifying the model layers
    ...
    def replay(self, batch_size):
        ...
        for Var1, Var2, Var3, Var4, RepVar5 in BatchMin:
            CompareVar7 = Var3
            if not RepVar5:
                CompareVar7 = (Var3 + self.gamma * np.amax(self.model.predict(Var4)[0]))
...
# Setting and identifying the game running model (Mountain Car Version 0)
if __name__ == "__main__":
    ...
    for e in range(RunningTimes):
        ...
        for time in range(500):
            ...
            Var1 = Var4
            if RepVar5:
                print("episode: {}/{}, score: {}, e: {:.2}".format(e, RunningTimes, time, agent.epsilon))
                break
